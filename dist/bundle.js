...
var minimist = __webpack_require__(3);
var args = minimist(process.argv.slice(2));
var inputPath = args._[0];
var tsPath = args.ts;
var elmPath = args.elm;
if (fs.existsSync(inputPath)) {
    var elmIpcFileContents = fs.readFileSync(inputPath).toString();
    var app = Elm.Main.worker({ elmIpcFileContents: elmIpcFileContents });
    app.ports.generatedFiles.subscribe(function (_a) {
        var typescriptCode = _a[0], elmCode = _a[1];
        fs.writeFileSync(tsPath, typescriptCode);
        fs.writeFileSync(elmPath, elmCode);
    });
    app.ports.parsingError.subscribe(function (errorString) {
...
var _dillonkearns$elm_electron$Electron_Ipc$errorOrNothing = function (result) {
	var _p0 = result;
	if (_p0.ctor === 'Ok') {
		return _elm_lang$core$Maybe$Nothing;
	} else {
...
var _dillonkearns$elm_electron$Electron_Ipc$isOk = function (result) {
	var _p1 = result;
	if (_p1.ctor === 'Ok') {
		return true;
	} else {
...
var _dillonkearns$elm_electron$Electron_Ipc$compositeResult = function (list) {
	return A2(_elm_lang$core$List$all, _dillonkearns$elm_electron$Electron_Ipc$isOk, list) ? _elm_lang$core$Result$Ok(
		A2(_elm_lang$core$List$filterMap, _elm_lang$core$Result$toMaybe, list)) : _elm_lang$core$Result$Err(
		A2(
			_elm_lang$core$String$join,
			'\n',
			A2(_elm_lang$core$List$filterMap, _dillonkearns$elm_electron$Electron_Ipc$errorOrNothing, list)));
};
var _dillonkearns$elm_electron$Electron_Ipc$msgValues = function (ast) {
	return A2(
		_elm_community$list_extra$List_Extra$find,
		function (_p2) {
			return !_elm_lang$core$List$isEmpty(_p2);
		},
		A2(
			_elm_lang$core$List$filterMap,
			function (statement) {
				var _p3 = statement;
				if ((((((_p3.ctor === 'TypeDeclaration') && (_p3._0.ctor === 'TypeConstructor')) && (_p3._0._0.ctor === '::')) && (_p3._0._0._0 === 'Msg')) && (_p3._0._0._1.ctor === '[]')) && (_p3._0._1.ctor === '[]')) {
...
var _dillonkearns$elm_electron$Electron_Ipc$MsgWithData = F2(
	function (a, b) {
		return {ctor: 'MsgWithData', _0: a, _1: b};
	});
var _dillonkearns$elm_electron$Electron_Ipc$Msg = function (a) {
	return {ctor: 'Msg', _0: a};
};
var _dillonkearns$elm_electron$Electron_Ipc$JsonEncodeValue = {ctor: 'JsonEncodeValue'};
var _dillonkearns$elm_electron$Electron_Ipc$String = {ctor: 'String'};
var _dillonkearns$elm_electron$Electron_Ipc$toElmIpc = function (statement) {
	var _p4 = statement;
	_v3_3:
	do {
		if (((_p4.ctor === 'TypeConstructor') && (_p4._0.ctor === '::')) && (_p4._0._1.ctor === '[]')) {
			if (_p4._1.ctor === '[]') {
				return _elm_lang$core$Result$Ok(
					_dillonkearns$elm_electron$Electron_Ipc$Msg(_p4._0._0));
			} else {
				if (_p4._1._1.ctor === '[]') {
					switch (_p4._1._0.ctor) {
						case 'TypeConstructor':
							if (_p4._1._0._1.ctor === '[]') {
								var _p6 = _p4._0._0;
								...
								do {
									if (_p5.ctor === '::') {
										if (_p5._1.ctor === '[]') {
											if (_p5._0 === 'String') {
												return _elm_lang$core$Result$Ok(
													A2(_dillonkearns$elm_electron$Electron_Ipc$MsgWithData, _p6, _dillonkearns$elm_electron$Electron_Ipc$String));
											} else {
												break _v4_2;
											}
										} else {
											if (((_p5._0 === 'Encode') && (_p5._1._0 === 'Value')) && (_p5._1._1.ctor === '[]')) {
												return _elm_lang$core$Result$Ok(
													A2(_dillonkearns$elm_electron$Electron_Ipc$MsgWithData, _p6, _dillonkearns$elm_electron$Electron_Ipc$JsonEncodeValue));
											} else {
												break _v4_2;
											}
										}
									...
									A2(
										...
										A2(
											...
											A2(
												_elm_lang$core$Basics_ops['++'],
												' constructor: ',
												A2(_elm_lang$core$String$join, '.', _p5)))));
							} else {
								break _v3_3;
							}
						case 'TypeRecord':
							return _elm_lang$core$Result$Err(
								A2(
									_elm_lang$core$Basics_ops['++'],
									'Record constructor parameters are not yet supported: ',
									A2(
										_elm_lang$core$Basics_ops['++'],
										_p4._0._0,
										A2(
											_elm_lang$core$Basics_ops['++'],
											' constructor: ',
											_elm_lang$core$Basics$toString(_p4._1._0._0)))));
						default:
							break _v3_3;
					}
				} else {
	...
	return _elm_lang$core$Result$Err(
		A2(
			_elm_lang$core$Basics_ops['++'],
			'Unhandled type constructor: ',
			_elm_lang$core$Basics$toString(_p4)));
};
var _dillonkearns$elm_electron$Electron_Ipc$toTypes = function (ipcFileAsString) {
	var _p7 = _Bogdanp$elm_ast$Ast$parse(ipcFileAsString);
	if ((_p7.ctor === 'Ok') && (_p7._0.ctor === '_Tuple3')) {
		return _dillonkearns$elm_electron$Electron_Ipc$compositeResult(
			A2(
				_elm_lang$core$List$map,
				_dillonkearns$elm_electron$Electron_Ipc$toElmIpc,
				A2(
					_elm_lang$core$Maybe$withDefault,
					{ctor: '[]'},
					_dillonkearns$elm_electron$Electron_Ipc$msgValues(_p7._0._2))));
	} else {
		return _elm_lang$core$Result$Err(
...
var _dillonkearns$elm_electron$Electron_Generator_ElmSerializer$parameterizedCase = F3(
	function (msgName, jsonEncodeValue, parameterName) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			'        ',
			A2(
						...
						A2(
							...
							A2(
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									'\", ',
									A2(_elm_lang$core$Basics_ops['++'], jsonEncodeValue, ' )'))))))));
	});
var _dillonkearns$elm_electron$Electron_Generator_ElmSerializer$generateCase = function (something) {
	var _p0 = something;
	if (_p0.ctor === 'Msg') {
		var _p1 = _p0._0;
		return A2(
			...
			A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					' ->\n            ( \"',
					A2(_elm_lang$core$Basics_ops['++'], _p1, '\", Encode.null )'))));
	} else {
		var _p3 = _p0._0;
		var _p2 = _p0._1;
		if (_p2.ctor === 'String') {
			return A3(_dillonkearns$elm_electron$Electron_Generator_ElmSerializer$parameterizedCase, _p3, 'Encode.string string', 'string');
		} else {
			return A3(_dillonkearns$elm_electron$Electron_Generator_ElmSerializer$parameterizedCase, _p3, 'value', 'value');
		}
	}
};
var _dillonkearns$elm_electron$Electron_Generator_ElmSerializer$fileHeader = 'module IpcSerializer exposing (serialize)\n\nimport Ipc exposing (Msg(..))\nimport Json.Encode as Encode\n\n\nserialize : Msg -> ( String, Encode.Value )\nserialize msg =\n    case msg of\n';
var _dillonkearns$elm_electron$Electron_Generator_ElmSerializer$generate = function (elmIpcList) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_dillonkearns$elm_electron$Electron_Generator_ElmSerializer$fileHeader,
		A2(
			_elm_lang$core$String$join,
			'\n\n',
			A2(_elm_lang$core$List$map, _dillonkearns$elm_electron$Electron_Generator_ElmSerializer$generateCase, elmIpcList)));
};

var _dillonkearns$elm_electron$Electron_Generator_Ts$ipcName = function (elmIpc) {
	var _p0 = elmIpc;
	if (_p0.ctor === 'Msg') {
		return _p0._0;
	} else {
...
var _dillonkearns$elm_electron$Electron_Generator_Ts$generateUnion = function (ipcList) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'type ElmIpc = ',
		A2(
			_elm_lang$core$String$join,
			' | ',
			A2(_elm_lang$core$List$map, _dillonkearns$elm_electron$Electron_Generator_Ts$ipcName, ipcList)));
};
var _dillonkearns$elm_electron$Electron_Generator_Ts$toTypescriptType = function (payloadType) {
	var _p1 = payloadType;
	if (_p1.ctor === 'String') {
		return 'string';
	} else {
...
var _dillonkearns$elm_electron$Electron_Generator_Ts$generateInterface = function (elmIpc) {
	var _p2 = elmIpc;
	if (_p2.ctor === 'Msg') {
		var _p3 = _p2._0;
		return A2(
				...
				A2(
					...
					A2(
						...
						A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								_dillonkearns$elm_electron$Electron_Generator_Ts$toTypescriptType(_p2._1),
								'\n}'))))));
	}
};
...
var _dillonkearns$elm_electron$Electron_Generator_Ts$generate = function (msgs) {
	return A2(
		...
		{
			ctor: '::',
			_0: _dillonkearns$elm_electron$Electron_Generator_Ts$prefix,
			_1: {
				ctor: '::',
				_0: _dillonkearns$elm_electron$Electron_Generator_Ts$generateUnion(msgs),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$core$String$join,
						'\n\n',
						A2(_elm_lang$core$List$map, _dillonkearns$elm_electron$Electron_Generator_Ts$generateInterface, msgs)),
					_1: {ctor: '[]'}
				}
			}
		});
...
var _dillonkearns$elm_electron$Main$update = F2(
	function (msg, model) {
		return A2(
...
var _dillonkearns$elm_electron$Main$workaround = _elm_lang$core$Json_Decode$string;
var _dillonkearns$elm_electron$Main$generatedFiles = _elm_lang$core$Native_Platform.outgoingPort(
	'generatedFiles',
	function (v) {
		return [v._0, v._1];
	});
var _dillonkearns$elm_electron$Main$parsingError = _elm_lang$core$Native_Platform.outgoingPort(
	'parsingError',
	function (v) {
		return v;
	});
var _dillonkearns$elm_electron$Main$crashOrOutputString = function (result) {
	var _p0 = result;
	if (_p0.ctor === 'Ok') {
		var _p1 = _p0._0;
		var elmCode = _dillonkearns$elm_electron$Electron_Generator_ElmSerializer$generate(_p1);
		var tsCode = _dillonkearns$elm_electron$Electron_Generator_Ts$generate(_p1);
		return _dillonkearns$elm_electron$Main$generatedFiles(
			{ctor: '_Tuple2', _0: tsCode, _1: elmCode});
	} else {
		return _dillonkearns$elm_electron$Main$parsingError(_p0._0);
	}
};
var _dillonkearns$elm_electron$Main$output = function (elmIpcFileContents) {
	return _dillonkearns$elm_electron$Main$crashOrOutputString(
		_dillonkearns$elm_electron$Electron_Ipc$toTypes(elmIpcFileContents));
};
var _dillonkearns$elm_electron$Main$init = function (flags) {
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		{ctor: '_Tuple0'},
		{
			ctor: '::',
			_0: _dillonkearns$elm_electron$Main$output(flags.elmIpcFileContents),
			_1: {ctor: '[]'}
		});
};
var _dillonkearns$elm_electron$Main$main = _elm_lang$core$Platform$programWithFlags(
	{
		init: _dillonkearns$elm_electron$Main$init,
		update: _dillonkearns$elm_electron$Main$update,
	...
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (elmIpcFileContents) {
			return _elm_lang$core$Json_Decode$succeed(
				{elmIpcFileContents: elmIpcFileContents});
		},
		A2(_elm_lang$core$Json_Decode$field, 'elmIpcFileContents', _elm_lang$core$Json_Decode$string)));
var _dillonkearns$elm_electron$Main$Flags = function (a) {
	return {elmIpcFileContents: a};
};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _dillonkearns$elm_electron$Main$main !== 'undefined') {
    _dillonkearns$elm_electron$Main$main(Elm['Main'], 'Main', undefined);
}
